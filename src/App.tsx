 ...
 * @LastEditTime: 2024-12-13 11:00:40
 */
...
const Home = () => {
  ...
  return (
    <EditorContext.Provider value={editor}>
      <div
        className="h-70px border-b-1 box-border border-#e6e6e6 border-b-solid px-10px"
        style={{ background: 'white' }}>
        <ToolBar className="text-#202020"></ToolBar>
      </div>
      <div
        className="flex w-100% overflow-hidden box-border"
        style={{
        ...
        <div className="flex-1 relative h-100% overflow-hidden">
          <div id="dx_container" className="absolute left-0px w-100% h-100% bg-#fff" ref={container}></div>
